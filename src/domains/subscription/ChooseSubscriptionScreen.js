...
export default function ChooseSubscriptionScreen({navigation}) {
              ...
              {activeCard === 0 && (
                <>
                  <Title style={styles.center}>
                    Choosing the Small Urbanfit
                  </Title>
                  <Paragraph style={styles.center}>
                    gives you access to X venues around Athens
                  </Paragraph>
                  <Paragraph style={styles.center}>
